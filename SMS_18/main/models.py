...
class UserProfile(models.Model):
	...
	balance=models.IntegerField(default=1000000) #this will contain the current balance throughout
...
class Stock(models.Model):
	...
	stock_price = models.FloatField(default=0.000) #Stock price at any instant
	...
	initial_price = models.FloatField(default=0.000)
